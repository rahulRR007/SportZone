...
export default function SignInSide() {
  ...
  const handleSubmit = (event) => {
    ...
    // Make an API request to your Spring Boot backend for login
    axios.post('http://localhost:8080/api/login', user)
      .then((response) => {
        ...
        // Navigate to the Tournaments page after a successful sign-in
        setTimeout(() => {
          ...
          >
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Grid container>
                ...
                <Grid item>
                  <Link href="/signup" variant="body2" sx={{ color: '#90caf9' }}>
